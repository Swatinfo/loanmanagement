...
@section('header')
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <a href="{{ route('quotations.show', $quotation) }}" class="btn-accent-outline btn-accent-sm btn-accent-outline-white"><svg style="width:14px;height:14px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg> Back</a>
    </div>
@endsection
    ...
    <div class="px-3 px-sm-4 px-lg-5" style="max-width: 48rem;">
        ...
        <form method="POST" action="{{ route('quotations.convert.store', $quotation) }}">
            ...
            <div class="d-flex justify-content-end gap-3 mb-4">
                <a href="{{ route('quotations.show', $quotation) }}" class="btn-accent-outline"><svg style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg> Cancel</a>
