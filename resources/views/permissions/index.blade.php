                ...
                <div class="shf-section-body">
                    ...
                    <form method="POST" action="{{ route('permissions.update') }}">
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-4">
                            <a href="{{ route('settings.index') }}" class="btn-accent-outline"><svg style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg> Cancel</a>
